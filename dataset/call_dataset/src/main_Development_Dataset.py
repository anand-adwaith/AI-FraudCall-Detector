...
def main():
    ...
    # Write to SyntheticNumber1000.txt
    with open("SyntheticNumber1000.txt", "w", encoding="utf-8") as txt_file:
    ...
    # Write to SyntheticNumbe1000.csv
    with open("SyntheticNumber1000.csv", "w", newline='', encoding="utf-8") as csv_file:
    ...
    print("Progress saved to SyntheticNumber1000.txt and SyntheticNumber1000.csv.")
